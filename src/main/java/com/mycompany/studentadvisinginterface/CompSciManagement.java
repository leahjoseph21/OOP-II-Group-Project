...
/**
 * Class that models a degree in Computer Science with Management and its courses
 * @author Leah
 */
public class CompSciManagement extends DcitDegree {
    ...
    public void loadSem1CourseLists() {
        ...
        while(found == false){
            for(i = 0; i < l;i++){
                if (courses.get(i).equals("CompSciManSem1")){
                    found = true;
                    pos = i;
                }
            }
    ...
    public void loadSem2CourseLists(){
        ...
        while(found == false){
            for(i = 0; i < l;i++){
                if (courses.get(i).equals("CompSciManSem2")){
                    found = true;
                    pos = i;
                }
            }
