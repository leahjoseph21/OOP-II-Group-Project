...
/**
 * Class that models a minor in Information Technology and its courses
 * @author Leah
 */
public class InfoTechMinor extends DcitDegree {
    ...
    public void loadSem1CourseLists() {
        ...
        while(found == false){
            for(i = 0; i < l;i++){
                if (courses.get(i).equals("InfoTechMinorSem1")){
                    found = true;
                    pos = i;
                }
            }
    ...
    public void loadSem2CourseLists(){
        ...
        while(found == false){
            for(i = 0; i < l;i++){
                if (courses.get(i).equals("InfoTechMinorSem2")){
                    found = true;
                    pos = i;
                }
            }
